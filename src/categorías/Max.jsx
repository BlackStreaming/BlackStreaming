...
const Max = () => {
  ...
  const renderProductStatus = (product) => {
    ...
    if (product.stock > 0) {
      return (
        <div className="absolute top-0 left-0 w-24 h-8 bg-purple-400 text-white flex items-center justify-center transform -rotate-45 -translate-x-6 translate-y-3 shadow-md rounded-br-lg">
          <span className="text-xs font-bold uppercase tracking-tight">
            Stock: {product.stock}
          </span>
        </div>
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-gray-200 flex flex-col">
          ...
          >
            ...
            <div className="relative z-10 text-center px-4">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-200 max-w-2xl mx-auto drop-shadow-md">
                Disfruta de tus películas y series favoritas con nuestras cuentas premium de Max
              </p>
            </div>
          </section>
                    ...
                    <div className="p-4 sm:p-5 flex flex-col flex-grow">
                      ...
                      <div className="text-sm text-gray-300 space-y-2 mb-3">
                        <div className="flex items-center space-x-2 bg-gray-700/50 p-2 rounded-md">
                          <FiUserCheck className="text-purple-400" size={16} />
      ...
      {notificationModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
          <div animate="fadeIn">
            <div className="bg-gray-800/90 rounded-xl shadow-2xl p-6 sm:p-8 w-full max-w-md border border-gray-700">
              <h3 className="text-xl sm:text-2xl font-bold text-white mb-4 flex items-center">
                <Fi className="mr-2 text-purple-600" info>Info</Fi>
                Notificación
              </h3>
              ...
              <div className="flex justify-end">
                <button onClick={() => {
                  ...
                  className="px-4 py-2 bg-purple-600 text-white rounded hover:bg-purple-700 transition-all rounded-md">
                  Aceptar
                </button>
              </div>
            </div>
