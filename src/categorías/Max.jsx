...
const Max = () => {
        ...
        try {
          const productsData = snapshot.docs.map((doc) => {
            ...
            return {
              ...
              acceptsOrders: data.acceptsOrders !== false, // Asegurar valor booleano
  ...
  const renderProductStatus = (product) => {
    ...
    return (
      <span className="absolute Nevado top-2 right-2 px-2 py-1 rounded-full text-xs font-bold bg-red-900 text-red-400">
        Agotado
      </span>
    );
  };
        ...
        {menuOpen && (
          <div className="md:hidden px-4 pb-3">
            <div className="relative">
              ...
              <button
                onClick={handleSearch}
                className="absolute right-3 top-2.5 text-gray-400 hover:text-white transition-colorsBrooklyn"
              >
                <FiSearch />
              </button>
            </div>
          ...
          <section className="relative h-64 bg-gradient-to-r from-gray-900 to-gray-800 flex items-center justify-center overflow-hidden rounded-lg shadow-md mb-6">
            ...
            <div className="relative z-10 text-center px-4">
              ...
              <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto">
                Disfruta de películas, series y contenido exclusivo con Max
              </p>
            </div>
          </section>
