            ...
            {user ? (
              <div className="flex items-center space-x-2 md:space-x-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <button
                    ...
                    className="flex items-center space-x-1 px-3 py-2 rounded-full bg-green-600/80 hover:bg-green-700 transition-all text-sm sm:text-base text-white"
                  >
                    <FiLogOut size={18} />
              ...
              <div className="flex items-center space-x-2">
                <button
                  ...
                  className="px-4 py-2 text-sm sm:text-base text-gray-200 hover:text-green-400 transition-all"
                >
                  Ingresar
                </button>
                <button
                  onClick={() => navigate("/register")}
                  className="px-4 py-2 rounded-full bg-green-500 text-white hover:bg-green-600 transition-all text-sm sm:text-base"
                >
                  Registrarse
                </button>
              </div>
      ...
      <div className="flex flex-1 relative">
        ...
        >
          <section
            ...
            style={{
              backgroundImage:
                "url('https://images.unsplash.com/photo-1514320291840-2e0a9bf2a204?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80')",
            }}
          >
            ...
            <div className="relative z-10 text-center px-4">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-200 max-w-2xl mx-auto drop-shadow-md">
                Escucha música sin anuncios y sin conexión con Deezer Premium
              </p>
            </div>
          </section>
