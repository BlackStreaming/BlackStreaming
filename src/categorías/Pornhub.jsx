...
const Pornhub = () => {
  ...
  const renderProductStatus = (product) => {
    ...
    return (
      <div className="absolute top-0 left-0 w-24 h-8 bg-red-700 text-white flex items-center justify-center transform -rotate-45 -translate-x-6 translate-y-3 shadow-md rounded-br-lg">
        <span className="text-xs font-bold uppercase tracking-tight">
          Agotado
        </span>
      </div>
          ...
          >
            ...
            <div className="relative z-10 text-center px-4">
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 drop-shadow-lg">
                Cuentas Premium de Pornhub
              </h1>
              <p className="text-base sm:text-lg md:text-xl text-gray-200 max-w-2xl mx-auto drop-shadow-md">
                Accede a contenido exclusivo con nuestras cuentas premium de Pornhub
              </p>
            </div>
          </section>
                    ...
                    <div className="p-4 sm:p-5 flex flex-col flex-grow">
                      ...
                      <div className="text-sm text-gray-300 space-y-2 mb-3">
                        <div className="flex items-center space-x-2 bg-gray-700/50 p-2 rounded-md">
                          <FiUserCheck className="text-red-700" size={16} />
                          <span className="text-gray-400 truncate">
                            {product.provider}
                          </span>
                        </div>
                        <div className="flex items-center space-x-2 bg-gray-700/50 p-2 rounded-md">
                          <FiClock className="text-red-700" size={16} />
                          <span className="text-gray-400">
                            {parseDurationToDays(product.duration || "1 mes")}
                          </span>
                        </div>
                        <div className="flex items-center space-x-2 bg-gray-700/50 p-2 rounded-md">
                          <FiTag className="text-red-700" size={16} />
                          <span className="text-gray-400">
                            {product.type || "Premium"}
                          </span>
                        </div>
                        <div className="flex items-center space-x-2 bg-gray-700/50 p-2 rounded-md">
                          <FiActivity className="text-red-700" size={16} />
            ...
            <div className="p-6 sm:p-8">
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 bg-gray-700/50 border border-gray-600/50 rounded-xl focus:ring-2 focus:ring-red-700 focus:border-red-700 text-white transition-all"
                    required
                  />
                </div>
                <div>
                ...
                <div className="flex items-start">
                  <input
                    type="checkbox"
                    id="termsCheck"
                    className="mt-1 mr-3 bg-gray-700 border-gray-600 text-red-700 focus:ring-red-700 rounded"
                    required
                  />
                  <label htmlFor="termsCheck" className="text-sm text-gray-300">
                    ...
                    <button
                      ...
                      className="text-red-700 hover:text-red-600 transition-all underline underline-offset-4"
                    >
                      Términos
                    </button>{" "}
                    y{" "}
              ...
              <div className="flex justify-end space-x-3 mt-8">
                ...
                <button
                  ...
                  disabled={loading}
                  className="px-4 py-2 bg-red-700 text-white rounded-xl hover:bg-red-800 disabled:bg-gray-700/50 disabled:text-gray-400 flex items-center transition-all"
                >
          ...
          <div className="bg-gray-800/90 backdrop-blur-md rounded-2xl shadow-2xl w-full max-w-md border border-gray-700/50 animate-fadeIn">
            <div className="p-6 sm:p-8">
              ...
              <button
                ...
                className="w-full py-3 bg-red-700 text-white rounded-xl hover:bg-red-800 transition-all"
              >
                Aceptar
              </button>
            </div>
            ...
            <div className="p-6 sm:p-8">
              ...
              <div className="text-gray-300">
                <div className="space-y-5">
                  ...
                  <div className="bg-gray-700/50 p-4 sm:p-5 rounded-xl border border salinity-600/50">
              ...
              <button
                onClick={() => setGeneralTermsModal(false)}
                className="w-full mt-6 py-3 bg-red-700 text-white rounded-xl hover:bg-red-800 transition-all"
              >
                Cerrar
              </button>
            </div>
