...
const Canva = () => {
  ...
  // Load products, accounts, and category counts
  useEffect(() => {
    // Query Canva products
    ...
    const productsUnsubscribe = onSnapshot(
      ...
      async (snapshot) => {
        ...
        // Fetch provider details for products without provider info
    ...
    // Query available Canva accounts
    ...
    // Query product counts for other categories
    const categories = [
      "Netflix",
      "Spotify",
      "Disney",
          ...
          >
            ...
            <div className="relative z-10 text-center px-4">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-200 max-w-2xl mx-auto drop-shadow-md">
                Diseña sin límites con nuestras cuentas premium de Canva
              </p>
            </div>
          </section>
