    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-gray-200 flex flex-col">
      ...
      <div className="flex flex-1 relative">
        ...
        >
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-r from-gray-900/80 to-green-900/50"></div>
            <div className="relative z-10 text-center px-4">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-200 max-w-2xl mx-auto drop-shadow-md">
                Vive la emoción del deporte con nuestras cuentas premium de Liga Max
              </p>
            </div>
          </section>
                ...
                <div className="flex items-start">
                  ...
                  <label htmlFor="termsCheck" className="text-sm text-gray-300">
                    ...
                    <button
                      ...
                      className="text-green-400 hover:text-green-300 transition-all underline underline-offset-4"
                    >
                      Términos
                    </button>{" "}
                    y{" "}
