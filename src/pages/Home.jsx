...
const platforms = [
  ...
  { name: "Cap cut", logo: capcutLogo, route: "/capcut", color: "#00CED1" },
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <motion.header
        ...
        className={`fixed top-0 left-0 right-0 z-50 border-b dark:border-gray-800 border-gray-200 shadow-lg ${
      ...
      >
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden lg:flex justify-center flex-1">
            ...
            >
              ...
              <motion.button
                ...
                className="absolute right-3 top-1/2 -translate-y-1/2 dark:text-cyan-400 text-blue-600"
                aria-label="Buscar"
              >
                <FaSearch size={20} />
              </motion.button>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            onClick={toggleMenu}
            className="lg:hidden p-2 rounded-full dark:text-cyan-300 text-blue-600 dark:hover:bg-gray-800 hover:bg-gray-100"
        ...
        <AnimatePresence>
          {isMenuOpen && (
            <motion.div
              ...
              className="lg:hidden fixed top-0 left-0 h-full w-64 bg-white dark:bg-gray-900 z-50 shadow-2xl border-r dark:border-gray-700 border-gray-200"
            >
              <div className="flex flex-col h-full">
                <div className="flex items-center justify-between p-4 border-b dark:border-gray-700 border-gray-200">
                  <span className="text-xl font-bold dark:text-cyan-300 text-blue-600">Menú</span>
                  <motion.button
                    whileHover={{ scale: 1.1 }}
                    whileTap={{ scale: 0.9 }}
                    onClick={toggleMenu}
                ...
                <div className="flex flex-col p-4 space-y-4">
                  <div className="relative">
                    <input
                      type="text"
                      placeholder="Buscar productos..."
                      className="w-full py-3 px-5 pr-12 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-cyan-500 focus:outline-none"
                      value={searchQuery}
                      onChange={(e) => setSearchQuery(e.target.value)}
                    />
                    <motion.button
                  ...
                  {user ? (
                    <>
                      <div className="flex items-center space-x-2">
                        <span className="text-base font-medium dark:text-cyan-300 text-blue-600">{user.name}</span>
                        <span className="text-base font-medium bg-gray-100 dark:bg-gray-800 dark:text-cyan-200 text-blue-800 px-4 py-1.5 rounded-full">
                          S/ {balance.toFixed(2)}
                        </span>
                      </div>
                      <motion.button
                      ...
                      <motion.button
                        ...
                        className={`flex items-center space-x-2 text-base text-left ${
                          liveMode
                            ? "text-red-500 dark:text-red-400"
                            : "dark:text-gray-200 text-gray-700 hover:dark:text-cyan-300 hover:text-blue-600"
                        }`}
                      >
                        <FaBroadcastTower size={18} />
                        <span>{liveMode ? "Desactivar modo live" : "Activar modo live"}</span>
                      </motion.button>
                      <motion.button
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                        ...
                        className="flex items-center space-x-2 text-base text-left text-red-500 dark:text-red-400 hover:text-red-600 dark:hover:text-red-300"
                      >
                        <FaSignOutAlt size={18} />
                        <span>Salir</span>
                      </motion.button>
      ...
      <main className="flex-grow pt-24">
        ...
        {!user && (
          <motion.section
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8 }}
            className="py-16 dark:bg-gradient-to-r dark:from-gray-900 dark:to-blue-950 bg-gradient-to-r from-blue-50 to-gray-100"
          >
      ...
      {/* Footer */}
      <footer
        className={`bg-gray-900 dark:bg-gray-900 bg-white dark:bg-gray-900 border-t dark:border-gray-800 border-gray-200 py-12`}
      >
