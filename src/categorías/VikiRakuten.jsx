          ...
          >
            ...
            <div className="relative z-10 text-center px-4">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-200 max-w-2xl mx-auto drop-shadow-md">
                Disfruta de los mejores dramas asiáticos y entretenimiento global con nuestras cuentas premium de Viki Rakuten
              </p>
            </div>
          </section>
            ...
            <div className="p-6 sm:p-8">
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 bg-gray-700/50 border border-gray-600/50 rounded-xl focus:ring-2 focus:ring-pink-500 focus:border-pink-500 text-white transition-all"
                    required
                  />
                </div>
                <div>
                ...
                <div className="flex items-start">
                  <input
                    type="checkbox"
                    id="termsCheck"
                    className="mt-1 mr-3 bg-gray-700 border-gray-600 text-pink-500 focus:ring-pink-500 rounded"
                    required
                  />
                  <label htmlFor="termsCheck" className="text-sm text-gray-300">
                    ...
                    <button
                      ...
                      className="text-pink-500 hover:text-pink-400 transition-all underline underline-offset-4"
                    >
                      Términos
                    </button>{" "}
                    y{" "}
              ...
              <div className="flex justify-end space-x-3 mt-8">
                ...
                <button
                  ...
                  disabled={loading}
                  className="px-4 py-2 bg-pink-500 text-white rounded-xl hover:bg-pink-600 disabled:bg-gray-700/50 disabled:text-gray-400 flex items-center transition-all"
                >
          ...
          <div className="bg-gray-800/90 backdrop-blur-md rounded-2xl shadow-2xl w-full max-w-md border border-gray-700/50 animate-fadeIn">
            <div className="p-6 sm:p-8">
              ...
              <button
                ...
                className="w-full py-3 bg-pink-500 text-white rounded-xl hover:bg-pink-600 transition-all"
              >
                Aceptar
              </button>
            </div>
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-md flex items-center justify-center z-50 p-4 sm:p-6">
          <div className="bg-gray-800/90 backdrop-blur-md rounded-2xl shadow-2xl w-full max-w-2xl max-h-[80vh] overflow-y-auto border border-gray-600/50 animate-fadeIn">
            <div className="p-6 sm:p-8">
              ...
              <button
                onClick={() => setGeneralTermsModal(false)}
                className="w-full mt-6 py-3 bg-pink-500 text-white rounded-xl hover:bg-pink-600 transition-all"
              >
                Cerrar
              </button>
            </div>
