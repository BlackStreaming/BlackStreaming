...
const Paramount = () => {
  ...
  const renderProductStatus = (product) => {
    ...
    return (
      <div className="absolute top-0 left-0 w-24 h-8 bg-blue-600 text-white flex items-center justify-center transform -rotate-45 -translate-x-6 translate-y-3 shadow-md rounded-br-lg">
        <span className="text-xs font-bold uppercase tracking-tight">
          Agotado
        </span>
      </div>
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-gray-900 to-black p-4">
        ...
        <button
          ...
          className="px-6 py-2 bg-blue-400 text-white rounded-full hover:bg-blue-500 transition-all shadow-lg"
        >
          Recargar
        </button>
      </div>
            ...
            {user ? (
              <div className="flex items-center space-x-2 md:space-x-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <button
                    ...
                    className="flex items-center space-x-1 px-3 py-2 rounded-full bg-blue-400/80 hover:bg-blue-500 transition-all text-sm text-white"
                  >
                    <FiLogOut size={18} />
              ...
              <div className="flex items-center space-x-2">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-full bg-blue-400 text-white hover:bg-blue-500 transition-all text-sm"
                >
                  Registrarse
                </button>
              </div>
        ...
        >
          <div className="flex flex-col h-full">
            ...
            <nav className="flex-1 overflow-y-auto p-4 space-y-2">
              ...
              <Link
                to="/paramount"
                className="flex items-center justify-between px-4 py-3 rounded-xl bg-blue-400/30 text-white border border-blue-400/30"
              >
                <div className="flex items-center space-x-2">
            ...
            {user && (
              <div className="p-4 border-t border-gray-800/50">
                <div className="flex items-center space-x-3 p-3 bg-gray-800/50 rounded-xl">
                  <div className="w-12 h-12 rounded-full bg-blue-400/30 flex items-center justify-center text-white font-bold text-lg">
          ...
          >
            ...
            <div className="relative z-10 text-center px-4">
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 drop-shadow-lg">
                Cuentas Premium de Paramount+
              </h1>
              <p className="text-base sm:text-lg md:text-xl text-gray-200 max-w-2xl mx-auto drop-shadow-md">
                Disfruta de películas y series exclusivas con nuestras cuentas premium de Paramount+
              </p>
            </div>
          </section>
            ...
            <div className="p-6 sm:p-8">
              ...
              <div className="flex justify-end space-x-3 mt-8">
                ...
                <button
                  ...
                  disabled={loading}
                  className="px-4 py-2 bg-blue-400 text-white rounded-xl hover:bg-blue-500 disabled:bg-gray-700/50 disabled:text-gray-400 flex items-center transition-all"
                >
          ...
          <div className="bg-gray-800/90 backdrop-blur-md rounded-2xl shadow-2xl w-full max-w-md border border-gray-700/50 animate-fadeIn">
            <div className="p-6 sm:p-8">
              ...
              <button
                ...
                className="w-full py-3 bg-blue-400 text-white rounded-xl hover:bg-blue-500 transition-all"
              >
                Aceptar
              </button>
            </div>
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-md flex items-center justify-center z-50 p-4 sm:p-6">
          <div className="bg-gray-800/90 backdrop-blur-md rounded-2xl shadow-2xl w-full max-w-2xl max-h-[80vh] overflow-y-auto border border-gray-600/50 animate-fadeIn">
            <div className="p-6 sm:p-8">
              ...
              <button
                onClick={() => setGeneralTermsModal(false)}
                className="w-full mt-6 py-3 bg-blue-400 text-white rounded-xl hover:bg-blue-500 transition-all"
              >
                Cerrar
              </button>
            </div>
