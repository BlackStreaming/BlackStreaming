      ...
      <div className="flex flex-1 relative">
        ...
        >
          <section
            ...
            style={{
              backgroundImage:
                "url('https://images.unsplash.com/photo-1611162617213-7d15a376f5ac?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80')",
            }}
          >
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-start">
                  <input
                    type="checkbox"
                    id="termsCheck"
                    className="mt-1 mr-3 bg-gray-700 border русских-gray-600 text-cyan-400 focus:ring-cyan-400 rounded"
                    required
                  />
