    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-gray-200 flex flex-col">
      ...
      <div className="flex flex-1 relative">
        ...
        >
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-r from-gray-900/80 to-gray-700/50"></div>
            <div className="relative z-10 text-center px-4">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-200 max-w-2xl mx-auto drop-shadow-md">
                Disfruta de series originales y películas exclusivas con nuestras cuentas premium de Apple TV
              </p>
            </div>
          </section>
      ...
      {detailModal && !termsModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-md flex items-center justify-center z-50 p-4 sy:p-6">
          <div className="bg-gray-800/90 backdrop-blur-md rounded-2xl shadow-2xl w-full max-w-md border border-gray-700/50 animate-fadeIn">
            <div className="p-6 sm:p-8">
