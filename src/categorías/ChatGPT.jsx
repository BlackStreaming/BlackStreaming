    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-gray-200 flex flex-col">
      ...
      <div className="flex flex-1 relative">
        ...
        >
          <div className="flex flex-col h-full">
            ...
            <nav className="flex-1 overflow-y-auto p-4 space-y-2">
              ...
              >
                <div className="flex items-center space-x-2">
                  <FiMessageSquare className="text-teal-500" />
                  <span>ChatGPT</span>
                </div>
                <span className="bg-gray-800/50 text-white text-xs font-bold rounded-full h-5 w-5 flex items-center justify-center">
        ...
        >
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-r from-gray-900/80 to-teal-900/50"></div>
            <div className="relative z-10 text-center px-4">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-200 max-w-2xl mx-auto drop-shadow-md">
                Potencia tu creatividad y productividad con nuestras cuentas premium de ChatGPT
              </p>
            </div>
          </section>
          ...
          <section className="container mx-auto px-4">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 space-y-4 sm:space-y-0">
              ...
              <button
                ...
                className="text-sm sm:text-base text-teal-400 hover:text-teal-300 transition-all underline underline-offset-4"
              >
                Términos Generales
              </button>
            </div>
                    ...
                    <div className="p-4 sm:p-5 flex flex-col flex-grow">
                      ...
                      <div className="text-sm text-gray-300 space-y-2 mb-3">
                        <div className="flex items-center space-x-2 bg-gray-700/50 p-2 rounded-md">
                          <FiUserCheck className="text-teal-500" size={16} />
                          <span className="text-gray-400 truncate">
                            {product.provider}
                          </span>
                        </div>
                        <div className="flex items-center space-x-2 bg-gray-700/50 p-2 rounded-md">
                          <FiClock className="text-teal-500" size={16} />
                          <span className="text-gray-400">
                            {parseDurationToDays(product.duration || "1 mes")}
                          </span>
                        </div>
                        <div className="flex items-center space-x-2 bg-gray-700/50 p-2 rounded-md">
                          <FiTag className="text-teal-500" size={16} />
                          <span className="text-gray-400">
                            {product.type || "Premium"}
                          </span>
                        </div>
                        <div className="flex items-center space-x-2 bg-gray-700/50 p-2 rounded-md">
                          <FiActivity className="text-teal-500" size={16} />
            ...
            <div className="p-6 sm:p-8">
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 bg-gray-700/50 border border-gray-600/50 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500 text-white transition-all"
                    required
                  />
                </div>
                <div>
                ...
                <div className="flex items-start">
                  <input
                    type="checkbox"
                    id="termsCheck"
                    className="mt-1 mr-3 bg-gray-700 border-gray-600 text-teal-500 focus:ring-teal-500 rounded"
                    required
                  />
                  <label htmlFor="termsCheck" className="text-sm text-gray-300">
                    ...
                    <button
                      ...
                      className="text-teal-400 hover:text-teal-300 transition-all underline underline-offset-4"
                    >
                      Términos
                    </button>{" "}
                    y{" "}
              ...
              <div className="flex justify-end space-x-3 mt-8">
                ...
                <button
                  ...
                  disabled={loading}
                  className="px-4 py-2 bg-teal-500 text-white rounded-xl hover:bg-teal-600 disabled:bg-gray-700/50 disabled:text-gray-400 flex items-center transition-all"
                >
          ...
          <div className="bg-gray-800/90 backdrop-blur-md rounded-2xl shadow-2xl w-full max-w-md border border-gray-700/50 animate-fadeIn">
            <div className="p-6 sm:p-8">
              ...
              <button
                ...
                className="w-full py-3 bg-teal-500 text-white rounded-xl hover:bg-teal-600 transition-all"
              >
                Aceptar
              </button>
            </div>
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-md flex items-center justify-center z-50 p-4 sm:p-6">
          <div className="bg-gray-800/90 backdrop-blur-md rounded-2xl shadow-2xl w-full max-w-2xl max-h-[80vh] overflow-y-auto border border-gray-600/50 animate-fadeIn">
            <div className="p-6 sm:p-8">
                ...
                <div className="space-y-5">
                  ...
                  <div className="bg-gray-700/50 p-4 sm:p-5 rounded-xl border border-gray-600/50">
                    ...
                    <p>
                      ...
                      problemas con tu cuenta durante este período, el proveedor
              ...
              <button
                onClick={() => setGeneralTermsModal(false)}
                className="w-full mt-6 py-3 bg-teal-500 text-white rounded-xl hover:bg-teal-600 transition-all"
              >
                Cerrar
              </button>
            </div>
