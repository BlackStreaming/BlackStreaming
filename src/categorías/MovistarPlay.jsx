...
const MovistarPlay = () => {
  ...
  const renderProductStatus = (product) => {
    ...
    if (product.stock > 0) {
      return (
        <div className="absolute top-0 left-0 w-24 h-8 bg-green-600 text-white flex items-center justify-center transform -rotate-45 -translate-x-6 translate-y-3 shadow-md rounded-br-lg">
          <span className="text-xs font-bold uppercase tracking-tight">
            Stock: {product.stock}
          </span>
        </div>
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-gray-900 to-black p-4">
        ...
        <button
          ...
          className="px-6 py-2 bg-green-600 text-white rounded-full hover:bg-green-700 transition-all shadow-lg"
        >
          Recargar
        </button>
      </div>
            ...
            {user ? (
              ...
              <div className="flex items-center space-x-2">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-full bg-green-600 text-white hover:bg-green-700 transition-all text-sm"
                >
                  Registrarse
                </button>
              </div>
      ...
      <div className="flex flex-1 relative">
        ...
        >
          <section
            ...
            style={{
              backgroundImage:
                "url('https://images.unsplash.com/photo-1534972195531-d756b9bfa9f2?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80')",
            }}
          >
            ...
            <div className="relative z-10 text-center px-4">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-200 max-w-2xl mx-auto drop-shadow-md">
                Disfruta de entretenimiento sin límites con nuestras cuentas premium de Movistar Play
              </p>
            </div>
          </section>
            ...
            <div className="p-6 sm:p-8">
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 bg-gray-700/50 border border-gray-600/50 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 text-white transition-all"
                    required
                  />
                </div>
                <div>
                ...
                <div className="flex items-start">
                  <input
                    type="checkbox"
                    id="termsCheck"
                    className="mt-1 mr-3 bg-gray-700 border-gray-600 text-green-500 focus:ring-green-500 rounded"
                    required
                  />
                  <label htmlFor="termsCheck" className="text-sm text-gray-300">
                    ...
                    <button
                      ...
                      className="text-green-500 hover:text-green-400 transition-all underline underline-offset-4"
                    >
                      Términos
                    </button>{" "}
                    y{" "}
              ...
              <div className="flex justify-end space-x-3 mt-8">
                ...
                <button
                  ...
                  disabled={loading}
                  className="px-4 py-2 bg-green-600 text-white rounded-xl hover:bg-green-700 disabled:bg-gray-700/50 disabled:text-gray-400 flex items-center transition-all"
                >
          ...
          <div className="bg-gray-800/90 backdrop-blur-md rounded-2xl shadow-2xl w-full max-w-md border border-gray-700/50 animate-fadeIn">
            <div className="p-6 sm:p-8">
              ...
              <button
                ...
                className="w-full py-3 bg-green-600 text-white rounded-xl hover:bg-green-700 transition-all"
              >
                Aceptar
              </button>
            </div>
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-md flex items-center justify-center z-50 p-4 sm:p-6">
          <div className="bg-gray-800/90 backdrop-blur-md rounded-2xl shadow-2xl w-full max-w-2xl max-h-[80vh] overflow-y-auto border border-gray-600/50 animate-fadeIn">
            <div className="p-6 sm:p-8">
              ...
              <button
                onClick={() => setGeneralTermsModal(false)}
                className="w-full mt-6 py-3 bg-green-600 text-white rounded-xl hover:bg-green-700 transition-all"
              >
                Cerrar
              </button>
            </div>
