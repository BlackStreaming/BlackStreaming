    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-gray-200 flex flex-col">
      <header className="sticky top-0 z-50 bg-gray-900/80 backdrop-blur-md border-b border-gray-800/50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between flex-wrap">
          ...
          <div className="flex items-center relative w-full sm:w-auto sm:max-w-xs md:max-w-md mt-3 sm:mt-0 order-3 sm:order-2 sm:mx-auto">
            <input
              type="text"
            ...
            {user ? (
              <div className="flex items-center space-x-2 md:space-x-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <button
                    ...
                    className="flex items-center space-x-1 px-3 py-2 rounded-full bg-red-600/80 hover:bg-red-700 transition-all text-sm sm:text-base text-white"
                  >
                    <FiLogOut size={18} />
              ...
              <div className="flex items-center space-x-2">
                <button
                  ...
                  className="px-4 py-2 text-sm sm:text-base text-gray-200 hover:text-red-400 transition-all"
                >
                  Ingresar
                </button>
                <button
                  onClick={() => navigate("/register")}
                  className="px-4 py-2 rounded-full bg-red-500 text-white hover:bg-red-600 transition-all text-sm sm:text-base"
                >
                  Registrarse
                </button>
              </div>
      ...
      <div className="flex flex-1 relative">
        <aside
          className={`fixed inset-y-0 left-0 w-56 sm:w-64 bg-gray-900/90 backdrop-blur-md text-white shadow-2xl transform ${
            menuOpen ? "translate-x-0" : "-translate-x-full"
          } transition-transform duration-300 ease-in-out z-50 md:static md:z-40 md:translate-x-0 border-r border-gray-800/30`}
        >
          <div className="flex flex-col h-full">
            <div className="flex justify-between items-center p-4 md:hidden">
              ...
              <button
                ...
                className="text-gray-200 hover:bg-gray-700/50 p-2 rounded-full"
              >
                <FiX size={24} />
              </button>
            </div>
        ...
        >
          <section
            ...
            style={{
              backgroundImage:
                "url('https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80')",
            }}
          >
                    ...
                    <div className="p-4 sm:p-5 flex flex-col flex-grow">
                      ...
                      <div className="text-sm text-gray-300 space-y-2 mb-3">
                        <div className="flex items-center space-x-2 bg-gray-700/50 p-2 rounded-md">
                          <FiUserCheck className="text-red-500" size={16} />
                        ...
                        <div className="flex items-center space-x-2 bg-gray-700/50 p-2 rounded-md">
                          <FiTag className="text-red-500" size={16} />
                          <span className="text-gray-400">
                            {product.accountType}
                          </span>
                        </div>
                        <div className="flex items-center space-x-2 bg-gray-700/50 p-2 rounded-md">
                          <FiActivity className="text-red-500" size={16} />
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                <input
                  type="checkbox"
                  id="termsCheck"
                  className="h-4 w-4 text-red-500 bg-gray-700 border-gray-600 rounded"
                />
