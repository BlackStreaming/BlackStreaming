      ...
      <div className="flex flex-1 relative">
        ...
        >
          <section
            ...
            style={{
              backgroundImage:
                "url('https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80')",
            }}
          >
            ...
            <div className="relative z-10 text-center px-4">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-200 max-w-2xl mx-auto drop-shadow-md">
                Escucha tu música favorita sin límites con nuestras cuentas premium de Spotify
              </p>
            </div>
          </section>
                    ...
                    <div className="p-4 sm:p-5 flex flex-col flex-grow">
                      ...
                      <div className="text-sm text-gray-300 space-y-2 mb-3">
                        <div className="flex items-center space-x-2 bg-gray-700/50 p-2 rounded-md">
                          <FiUserCheck className="text-green-400" size={16} />
                        ...
                        <div className="flex items-center space-x-2 bg-gray-700/50 p-2 rounded-md">
                          <FiTag className="text-green-400" size={16} />
                          <span className="text-gray-400">
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 bg-gray-700/50 border border-gray-600/50 rounded-xl focus:ring-2 focus:ring-green-400 focus:border-green-400 text-white transition-all"
                    required
                  />
                </div>
                <div>
                ...
                <div className="flex items-start">
                  <input
                    type="checkbox"
                    id="termsCheck"
                    className="mt-1 mr-3 bg-gray-700 border-gray-600 text-green-400 focus:ring-green-400 rounded"
                    required
                  />
