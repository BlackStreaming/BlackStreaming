    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-gray-900 to-black p-4">
        ...
        <button
          ...
          className="px-6 py-2 bg-yellow-500 text-white rounded-full hover:bg-yellow-600 transition-all shadow-lg"
        >
          Recargar
        </button>
      </div>
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-gray-200 flex flex-col">
          ...
          >
            ...
            <div className="relative z-10 text-center px-4">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-200 max-w-2xl mx-auto drop-shadow-md">
                Accede a herramientas avanzadas para localizar personas de manera rápida y segura
              </p>
            </div>
          </section>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4 animate-fadeIn">
          <div className="bg-gray-800/90 rounded-xl shadow-2xl p-6 sm:p-8 w-full max-w-md border border-gray-700/50">
            <h3 className="text-xl sm:text-2xl font-bold text-white mb-4 flex items-center">
              <FiShoppingCart className="mr-2 text-yellow-400" /> Confirmar Compra
            </h3>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 rounded-md bg-gray-700/50 text-white border border-gray-600 focus:ring-2 focus:ring-yellow-400 focus:border-yellow-400 transition-all"
            ...
            <div className="flex justify-end space-x-3 mt-6">
              ...
              <button
                ...
                disabled={loading}
                className={`px-4 py-2 bg-yellow-500 text-white rounded-md hover:bg-yellow-600 transition-all flex items-center ${
      ...
      {detailModal && !termsModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4 animate-fadeIn">
          <div className="bg-gray-800/90 rounded-xl shadow-2xl p-6 sm:p-8 w-full max-w-md border border-gray-700/50">
            <h3 className="text-xl sm:text-2xl font-bold text-white mb-4 flex items-center">
              <FiInfo className="mr-2 text-yellow-400" /> Detalles del Producto
            </h3>
      ...
      {detailModal && termsModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4 animate-fadeIn">
          <div className="bg-gray-800/90 rounded-xl shadow-2xl p-6 sm:p-8 w-full max-w-md border border-gray-700/50">
            <h3 className="text-xl sm:text-2xl font-bold text-white mb-4 flex items-center">
              <FiFileText className="mr-2 text-yellow-400" /> Términos y Condiciones
            </h3>
            <div className="space-y-3 text-gray-300">
              <p>
      ...
      {generalTermsModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4 animate-fadeIn">
          <div className="bg-gray-800/90 rounded-xl shadow-2xl p-6 sm:p-8 w-full max-w-md border border-gray-700/50">
            <h3 className="text-xl sm:text-2xl font-bold text-white mb-4 flex items-center">
              <FiFileText className="mr-2 text-yellow-400" /> Términos Generales
            </h3>
      ...
      {notificationModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4 animate-fadeIn">
          <div className="bg-gray-800/90 rounded-xl shadow-2xl p-6 sm:p-8 w-full max-w-md border border-gray-700/50">
            <h3 className="text-xl sm:text-2xl font-bold text-white mb-4 flex items-center">
              <FiInfo className="mr-2 text-yellow-400" /> Notificación
            </h3>
