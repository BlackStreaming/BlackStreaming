              ...
              <div className="flex items-center space-x-2 md:space-x-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <button
                    ...
                    className="flex items-center space-x-1 px-3 py-2 rounded-full bg-red-500/80 hover:bg-red-600 transition-all text-sm text-white"
                  >
                    <FiLogOut size={18} />
          ...
          >
            ...
            <div className="relative z-10 text-center px-4">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-200 max-w-2xl mx-auto drop-shadow-md">
                Disfruta de canales en vivo y contenido exclusivo con nuestras cuentas premium de Flujo TV
              </p>
            </div>
          </section>
