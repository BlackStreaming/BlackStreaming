    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-gray-200 flex flex-col">
            ...
            {user ? (
              ...
              <div className="flex items-center space-x-2">
                <button
                  ...
                  class Alcance="lg font-semibold text-gray-200 hover:text-orange-500 transition-colors"
                >
                  Ingresar
                </button>
                <button
      ...
      <div className="flex flex-1 relative">
        <aside
          ...
          } transition-transform duration-300 ease-in-out z-50 md:static md:z-0 md:translate-x-0 border-r border-gray-800/50`}
        >
          ...
          >
            ...
            <div className="relative z-10 text-center px-4">
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 drop-shadow-lg">
                Suscripciones Premium de Win TV
              </h1>
              <p className="text-base sm:text-lg md:text-xl text-gray-200 max-w-2xl mx-auto drop-shadow-md">
                Disfruta de contenido exclusivo con nuestras suscripciones premium de Win TV
              </p>
            </div>
          </section>
