      ...
      <div className="flex flex-1 relative">
        ...
        >
          <div className="flex flex-col h-full">
            ...
            <nav className="flex-1 overflow-y-auto p-4 space-y-2">
              ...
              >
                <div className="flex items-center space-x-2">
                  <FiTv className="text-orange-400" />
                  <span>Win Tv</span>
                </div>
                <span className="bg-gray-800/50 text-white text-xs font-bold rounded-full h-5 w-5 flex items-center justify-center">
                  {productsCount.wintv}
        ...
        >
          <section
            ...
            style={{
              backgroundImage:
                "url('https://images.unsplash.com/photo-1598899134739-24c46f58b8c0?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80')",
            }}
          >
            ...
            <div className="relative z-10 text-center px-4">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-200 max-w-2xl mx-auto drop-shadow-md">
                Disfruta de tus eventos deportivos favoritos con nuestras cuentas premium de Win TV
              </p>
            </div>
          </section>
          ...
          <section className="container mx-auto px-4">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 space-y-4 sm:space-y-0">
              ...
              <button
                ...
                className="text-sm sm:text-base text-amber-400 hover:text-amber-300 transition-all underline underline-offset-4"
              >
                Términos Generales
              </button>
            </div>
                    ...
                    <div className="p-4 sm:p-5 flex flex-col flex-grow">
                      ...
                      <div className="text-sm text-gray-300 space-y-2 mb-3">
                        <div className="flex items-center space-x-2 bg-gray-700/50 p-2 rounded-md">
                          <FiUserCheck className="text-amber-400" size={16} />
                        ...
                        <div className="flex items-center space-x-2 bg-gray-700/50 p-2 rounded-md">
                          <FiActivity className="text-amber-400" size={16} />
            ...
            <div className="p-6 sm:p-8">
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 bg-gray-700/50 border border-gray-600/50 rounded-xl focus:ring-2 focus:ring-amber-400 focus:border-amber-400 text-white transition-all"
                    required
                  />
                </div>
                <div>
                ...
                <div className="flex items-start">
                  <input
                    type="checkbox"
                    id="termsCheck"
                    className="mt-1 mr-3 bg-gray-700 border-gray-600 text-amber-400 focus:ring-amber-400 rounded"
                    required
                  />
                  <label htmlFor="termsCheck" className="text-sm text-gray-300">
                    ...
                    <button
                      ...
                      className="text-amber-400 hover:text-amber-300 transition-all underline underline-offset-4"
                    >
                      Términos
                    </button>{" "}
                    y{" "}
              ...
              <div className="flex justify-end space-x-3 mt-8">
                ...
                <button
                  ...
                  disabled={loading}
                  className="px-4 py-2 bg-amber-500 text-white rounded-xl hover:bg-amber-600 disabled:bg-gray-700/50 disabled:text-gray-400 flex items-center transition-all"
                >
          ...
          <div className="bg-gray-800/90 backdrop-blur-md rounded-2xl shadow-2xl w-full max-w-md border border-gray-700/50 animate-fadeIn">
            <div className="p-6 sm:p-8">
              ...
              <button
                ...
                className="w-full py-3 bg-amber-500 text-white rounded-xl hover:bg-amber-600 transition-all"
              >
                Aceptar
              </button>
            </div>
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-md flex items-center justify-center z-50 p-4 sm:p-6">
          <div className="bg-gray-800/90 backdrop-blur-md rounded-2xl shadow-2xl w-full max-w-2xl max-h-[80vh] overflow-y-auto border border-gray-600/50 animate-fadeIn">
            <div className="p-6 sm:p-8">
              ...
              <button
                onClick={() => setGeneralTermsModal(false)}
                className="w-full mt-6 py-3 bg-amber-500 text-white rounded-xl hover:bg-amber-600 transition-all"
              >
                Cerrar
              </button>
            </div>
