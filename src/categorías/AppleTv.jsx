...
const AppleTV = () => {
  ...
  useEffect(() => {
    ...
    const productsUnsubscribe = onSnapshot(
      ...
      (err) => {
        setError("Error al cargar productos de Apple TV");
        console.error(err);
      }
    );
  ...
  const handleSearch = (e) => {
    e.preventDefault();
    if (searchQuery.trim()) {
      navigate(`/search?q=${encodeURIComponent(searchQuery)}&category=Apple Tv`);
    }
  };
  ...
  const renderProductStatus = (product) => {
    if (product.status === "A pedido") {
      return (
        <div className="absolute top-0 left-0 w-24 h-8 bg-gray-400 text-black flex items-center justify-center transform -rotate-45 -translate-x-6 translate-y-3 shadow-md rounded-br-lg">
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-gray-800 to-black text-gray-200">
        <FiLoader className="animate-spin text-5xl text-gray-400 mb-4" />
  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-gray-800 to-black p-4">
        ...
        <button
          ...
          className="px-6 py-2 bg-gray-400 text-black rounded-full hover:bg-gray-500 transition-all shadow-lg"
        >
          Recargar
        </button>
      </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-800 to-black text-gray-200 flex flex-col">
        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between flex-wrap">
          <div className="flex items-center space-x-3">
            ...
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="text-xl font-semibold text-gray-400 hidden sm:block">
                BlackStreaming
              </span>
            </Link>
          </div>
          ...
          <div className="flex items-center relative w-full sm:w-auto sm:max-w-xs md:max-w-md mt-3 sm:mt-0 order-3 sm:order-2 sm:mx-3">
            <input
              ...
              className="w-full px-4 py-2 rounded-full bg-gray-700/50 text-gray-200 border border-gray-600 focus:ring-2 focus:ring-gray-400 focus:border-gray-400 transition-all placeholder-gray-500"
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
            />
            <button
              onClick={handleSearch}
              className="absolute right-3 text-gray-400 hover:text-gray-300 transition-all"
            >
              <FiSearch size={20} />
            </button>
          </div>
            ...
            {user ? (
              <div className="flex items-center space-x-2 md:space-x-4">
                <span className="text-sm font-medium text-gray-300 hidden sm:flex items-center">
                  <FiUser className="mr-2 text-gray-400" /> {user.name}
                </span>
                <div className="flex items-center space-x-2">
                  <span className="text-sm font-medium text-gray-200 bg-gray-700/50 px-3 py-1 rounded-full">
                    S/ {balance.toFixed(2)}
                  </span>
                  <button
                    onClick={goToDashboard}
                    className="p-2 rounded-full bg-gray-700/50 hover:bg-gray-600/50 transition-all"
                    title="Dashboard"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center space-x-1 px-3 py-2 rounded-full bg-gray-400 text-black hover:bg-gray-500 transition-all text-sm"
                  >
                    <FiLogOut size={18} />
              ...
              <div className="flex items-center space-x-2">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-full bg-gray-400 text-black hover:bg-gray-500 transition-all text-sm"
                >
                  Registrarse
                </button>
              </div>
      ...
      <div className="flex flex-1 relative">
        <aside
          ...
          } transition-transform duration-300 ease-in-out z-50 md:static md:z-40 md:translate-x-0 border-r border-gray-700/50`}
        >
          <div className="flex flex-col h-full">
            ...
            <nav className="flex-1 overflow-y-auto p-4 space-y-2">
              ...
              >
                ...
                <span className="bg-gray-700/50 text-white text-xs font-bold rounded-full h-5 w-5 flex items-center justify-center">
              ...
              <Link
                to="/appletv"
                className="flex items-center justify-between px-4 py-3 rounded-xl bg-gray-600/30 text-white border border-gray-400/30"
              >
                <div className="flex items-center space-x-2">
            ...
            {user && (
              <div className="p-4 border-t border-gray-700/50">
                <div className="flex items-center space-x-3 p-3 bg-gray-700/50 rounded-xl">
                  <div className="w-12 h-12 rounded-full bg-gray-400/30 flex items-center justify-center text-white font-bold text-lg">
        ...
        >
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-r from-gray-800/80 to-black/50"></div>
            <div className="relative z-10 text-center px-4">
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 drop-shadow-lg">
                Cuentas Premium de Apple TV
              </h1>
              <p className="text-base sm:text-lg md:text-xl text-gray-200 max-w-2xl mx-auto drop-shadow-md">
                Disfruta de series y películas exclusivas con nuestras cuentas premium de Apple TV
              </p>
            </div>
          </section>
          ...
          <section className="container mx-auto px-4">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 space-y-4 sm:space-y-0">
              ...
              <button
                ...
                className="text-sm sm:text-base text-gray-400 hover:text-gray-300 transition-all underline underline-offset-4"
              >
                Términos Generales
              </button>
            </div>
            ...
            {filteredProducts.length === 0 ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full">
                {filteredProducts.map((product) => (
                  <div
                    key={product.id}
                    className="bg-gray-700/90 backdrop-blur-md rounded-xl shadow-lg overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300 w-full border border-gray-600/50 flex flex-col"
                  >
                    ...
                    <div className="p-4 sm:p-5 flex flex-col flex-grow">
                      ...
                      <div className="text-sm text-gray-300 space-y-2 mb-3">
                        <div className="flex items-center space-x-2 bg-gray-600/50 p-2 rounded-md">
                          <FiUserCheck className="text-gray-400" size={16} />
                      ...
                      <div className="flex justify-center items-center gap-3 mb-3">
                        <button
                          ...
                          className="flex-1 py-2 px-3 bg-gray-600/50 hover:bg-gray-500/50 text-white rounded-md text-sm flex items-center justify-center transition-all border border-gray-500/50"
                        >
                      ...
                      <button
                        ...
                        className={`w-full py-3 px-4 rounded-md text-black font-semibold transition-all flex items-center justify-center gap-2 ${
      ...
      {purchaseModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4 animate-fadeIn">
          <div className="bg-gray-700/90 rounded-xl shadow-2xl p-6 sm:p-8 w-full max-w-md border border-gray-600/50">
            <h3 className="text-xl sm:text-2xl font-bold text-white mb-4 flex items-center">
              <FiShoppingCart className="mr-2 text-gray-400" /> Confirmar Compra
            </h3>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 rounded-md bg-gray-600/50 text-white border border-gray-500 focus:ring-2 focus:ring-gray-400 focus:border-gray-400 transition-all"
              ...
              <div className="flex items-center">
                <input
                  type="checkbox"
                  id="termsCheck"
                  className="h-4 w-4 text-gray-400 bg-gray-600 border-gray-500 rounded focus:ring-gray-400"
                />
            ...
            <div className="flex justify-end space-x-3 mt-6">
              <button
                ...
                className="px-4 py-2 bg-gray-600/50 text-white rounded-md hover:bg-gray-500/50 transition-all"
              >
                Cancelar
              </button>
              <button
                ...
                disabled={loading}
                className={`px-4 py-2 bg-gray-400 text-black rounded-md hover:bg-gray-500 transition-all flex items-center ${
      ...
      {detailModal && !termsModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4 animate-fadeIn">
          <div className="bg-gray-700/90 rounded-xl shadow-2xl p-6 sm:p-8 w-full max-w-md border border-gray-600/50">
            <h3 className="text-xl sm:text-2xl font-bold text-white mb-4 flex items-center">
              <FiInfo className="mr-2 text-gray-400" /> Detalles del Producto
            </h3>
      ...
      {detailModal && termsModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4 animate-fadeIn">
          <div className="bg-gray-700/90 rounded-xl shadow-2xl p-6 sm:p-8 w-full max-w-md border border-gray-600/50">
            <h3 className="text-xl sm:text-2xl font-bold text-white mb-4 flex items-center">
              <FiFileText className="mr-2 text-gray-400" /> Términos y Condiciones
            </h3>
            <div className="space-y-3 text-gray-300">
              <p>
            ...
            <div className="flex justify-end mt-6 space-x-3">
              ...
              {purchaseModal && (
                <button
                  ...
                  className="px-4 py-2 bg-gray-400 text-black rounded-md hover:bg-gray-500 transition-all"
                >
                  Volver a Compra
                </button>
              )}
      ...
      {generalTermsModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4 animate-fadeIn">
          <div className="bg-gray-700/90 rounded-xl shadow-2xl p-6 sm:p-8 w-full max-w-md border border-gray-600/50">
            <h3 className="text-xl sm:text-2xl font-bold text-white mb-4 flex items-center">
              <FiFileText className="mr-2 text-gray-400" /> Términos Generales
            </h3>
      ...
      {notificationModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4 animate-fadeIn">
          <div className="bg-gray-700/90 rounded-xl shadow-2xl p-6 sm:p-8 w-full max-w-md border border-gray-600/50">
            <h3 className="text-xl sm:text-2xl font-bold text-white mb-4 flex items-center">
              <FiInfo className="mr-2 text-gray-400" /> Notificación
            </h3>
