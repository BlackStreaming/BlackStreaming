    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-blue-950 text-gray-200">
      ...
      <aside className={`fixed inset-y-0 left-0 transform ${menuOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 transition-transform duration-300 ease-in-out z-40 w-64 bg-gray-900/90 backdrop-blur-md border-r border-gray-800/50 overflow-y-auto`}>
        <div className="p-4 flex flex-col h-full">
            ...
            <ul className="space-y-2">
              <li>
                <button
                  ...
                  className={`w-full flex items-center px-4 py-3 rounded-xl transition-all duration-300 ${
                    activeSection === "inicio" ? "bg-cyan-500/20 text-cyan-400" : "text-gray-300 hover:bg-gray-800/50"
                  }`}
                >
              ...
              <li>
                <button
                  ...
                  className={`w-full flex items-center px-4 py-3 rounded-xl transition-all duration-300 ${
                    activeSection === "inventario" ? "bg-cyan-500/20 text-cyan-400" : "text-gray-300 hover:bg-gray-800/50"
                  }`}
                >
              ...
              <li>
                <button
                  ...
                  className={`w-full flex items-center px-4 py-3 rounded-xl transition-all duration-300 ${
                    activeSection === "subirProducto" ? "bg-cyan-500/20 text-cyan-400" : "text-gray-300 hover:bg-gray-800/50"
                  }`}
                >
              ...
              <li>
                <button
                  ...
                  className={`w-full flex items-center px-4 py-3 rounded-xl transition-all duration-300 ${
                    activeSection === "ganancias" ? "bg-cyan-500/20 text-cyan-400" : "text-gray-300 hover:bg-gray-800/50"
                  }`}
                >
              ...
              <li>
                <button
                  ...
                  className={`w-full flex items-center px-4 py-3 rounded-xl transition-all duration-300 ${
                    activeSection === "pedidos" ? "bg-cyan-500/20 text-cyan-400" : "text-gray-300 hover:bg-gray-800/50"
                  }`}
                >
              ...
              <li>
                <button
                  ...
                  className={`w-full flex items-center px-4 py-3 rounded-xl transition-all duration-300 ${
                    activeSection === "retiros" ? "bg-cyan-500/20 text-cyan-400" : "text-gray-300 hover:bg-gray-800/50"
                  }`}
                >
              ...
              <li>
                <button
                  ...
                  className={`w-full flex items-center px-4 py-3 rounded-xl transition-all duration-300 ${
                    activeSection === "configuracion" ? "bg-cyan-500/20 text-cyan-400" : "text-gray-300 hover:bg-gray-800/50"
                  }`}
                >
          ...
          <button
            onClick={handleLogout}
            className="mt-4 flex items-center px-4 py-3 text-red-400 hover:bg-gray-800/50 rounded-xl transition-all duration-300"
          >
      ...
      <main className="md:ml-64 p-4 sm:p-6">
        ...
        {editModalOpen && selectedProduct && (
          <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-gray-800/90 backdrop-blur-sm rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto border border-gray-700/50">
              <div className="p-4 sm:p-6">
                <div className="flex justify-between items-center mb-6">
                  ...
                  >
                    <FiClose className="text-xl text-gray-300" />
                  </button>
                </div>
                {editError && (
                  <div className="bg-red-900/80 border-l-4 border-red-500 p-4 mb-6 rounded-xl">
        ...
        {successModal.open && (
          <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-gray-800/90 backdrop-blur-sm rounded-2xl shadow-2xl p-6 max-w-md w-full border border-gray-700/50">
              <div className="text-center">
                <FiCheckCircle className="mx-auto text-4xl text-green-400 mb-4" />
                <h3 className="text-xl font-bold text-white mb-2">¡Éxito!</h3>
                <p className="text-gray-300 mb-6">{successModal.message}</p>
                <button
                  onClick={() => setSuccessModal({ open: false, message: "" })}
                  className="px-6 py-2 bg-cyan-500 hover:bg-cyan-600 text-white rounded-xl font-medium transition-all duration-300"
                >
                  Aceptar
                </button>
              </div>
