...
const Duolingo = () => {
    ...
    return (
      <div className="flex items-center space-x-1">
        {[...Array(fullStars)].map((_, i) => (
          <FiStar key={`full-${i}`} className="text-green-400" size={16} fill="currentColor" />
        ))}
        {hasHalfStar && (
          <FiStar
  ...
  useEffect(() => {
    ...
    const productsUnsubscribe = onSnapshot(
      ...
      async (snapshot) => {
        ...
        setProductsCount((prev) => ({
          ...prev,
          duolingo: productsWithProviders.length,
        }));
      },
      (err) => {
        setError("Error al cargar productos de Duolingo");
        console.error(err);
      }
    );
    ...
    const accountsQuery = query(
      collection(db, "duolingo_accounts"),
  ...
  const handleSearch = (e) => {
    e.preventDefault();
    if (searchQuery.trim()) {
      navigate(`/search?q=${encodeURIComponent(searchQuery)}&category=Duolingo`);
    }
  };
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-gray-900 to-black text-gray-200">
        <FiLoader className="animate-spin text-5xl text-green-400 mb-4" />
  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-gray-900 to-black p-4">
        <FiAlertCircle className="text-5xl text-green-400 mb-4" />
        ...
        <button
          ...
          className="px-6 py-2 bg-green-400 text-white rounded-full hover:bg-green-500 transition-all shadow-lg"
        >
          Recargar
        </button>
      </div>
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-gray-200 flex flex-col">
        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between flex-wrap">
          <div className="flex items-center space-x-3">
            ...
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="text-xl font-semibold text-green-400 hidden sm:block">
                BlackStreaming
              </span>
            </Link>
          </div>
          ...
          <div className="flex items-center relative w-full sm:w-auto sm:max-w-xs md:max-w-md mt-3 sm:mt-0 order-3 sm:order-2 sm:mx-3">
            <input
              type="text"
              placeholder="Buscar en Duolingo..."
            ...
            {user ? (
              <div className="flex items-center space-x-2 md:space-x-4">
                <span className="text-sm font-medium text-gray-300 hidden sm:flex items-center">
                  <FiUser className="mr-2 text-green-400" /> {user.name}
                </span>
                <div className="flex items-center space-x-2">
                  ...
                  <button
                    ...
                    className="flex items-center space-x-1 px-3 py-2 rounded-full bg-green-400/80 hover:bg-green-500 transition-all text-sm text-white"
                  >
                    <FiLogOut size={18} />
              ...
              <div className="flex items-center space-x-2">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-full bg-green-400 text-white hover:bg-green-500 transition-all text-sm"
                >
                  Registrarse
                </button>
              </div>
      ...
      <div className="flex flex-1 relative">
        ...
        >
          <div className="flex flex-col h-full">
            ...
            <nav className="flex-1 overflow-y-auto p-4 space-y-2">
              ...
              <Link
                to="/duolingo"
                className="flex items-center justify-between px-4 py-3 rounded-xl bg-green-400/30 text-white border border-green-400/30"
              >
                <div className="flex items-center space-x-2">
            ...
            {user && (
              <div className="p-4 border-t border-gray-800/50">
                <div className="flex items-center space-x-3 p-3 bg-gray-800/50 rounded-xl">
                  <div className="w-12 h-12 rounded-full bg-green-400/30 flex items-center justify-center text-white font-bold text-lg">
        ...
        >
          <section
            ...
            style={{
              backgroundImage:
                "url('https://images.unsplash.com/photo-1516321310762-479437144403?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80')",
            }}
          >
            ...
            <div className="relative z-10 text-center px-4">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-200 max-w-2xl mx-auto drop-shadow-md">
                Aprende idiomas de forma divertida con nuestras suscripciones a Duolingo
              </p>
            </div>
          </section>
                  ...
                  >
                    ...
                    <div className="flex flex-col flex-grow p-4 pb-3">
                      <div className="flex items-center justify-between mb-1.5">
                        <span className="uppercase font-bold tracking-wide text-xs text-green-400 bg-green-900/20 px-2 py-0.5 rounded-md">
                          {product.accountType}
                        </span>
                        <span className="text-xs text-gray-400 flex items-center gap-1">
                          <FiClock className="text-green-400" size={13} />
                      ...
                      <div className="flex items-center gap-2 mb-2">
                        <span className="flex items-center text-xs text-gray-300 gap-1">
                          <FiUserCheck className="text-green-400" size={13} />
                          {product.provider}
                        </span>
                        <span className="flex items-center text-xs text-gray-400 gap-1">
                          <FiActivity className="text-green-400" size={13} />
                          {product.status}
                        </span>
                      </div>
                      ...
                      <div className="flex-1 flex flex-col justify-end">
                        ...
                        <div className="flex gap-2 mb-2">
                          ...
                          >
                            <FiInfo className="text-green-400" size={14} />
                            <span>Detalles</span>
                          </button>
                          <button
                            ...
                            style={{ backdropFilter: "blur(2px)" }}
                          >
                            <FiFileText className="text-green-400" size={14} />
                            <span>Términos</span>
                          </button>
                        </div>
                        <button
                          ...
                          className={`w-full py-2 px-3 rounded-xl font-semibold text-sm flex items-center justify-center gap-2 shadow-lg transition-all duration-200
                            ${
                              Number(product.stock) > 0 || product.status === "A pedido"
                                ? "bg-gradient-to-r from-green-400 via-green-500 to-emerald-500 hover:from-green-500 hover:to-emerald-600 text-white"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4 animate-fadeIn">
          <div className="bg-gray-800/90 rounded-xl shadow-2xl p-6 sm:p-8 w-full max-w-md border border-gray-700/50">
            <h3 className="text-xl sm:text-2xl font-bold text-white mb-4 flex items-center">
              <FiShoppingCart className="mr-2 text-green-400" /> Confirmar Compra
            </h3>
            ...
            <div className="flex justify-end space-x-3 mt-6">
              ...
              <button
                ...
                disabled={loading}
                className={`px-4 py-2 bg-green-400 text-white rounded-md hover:bg-green-500 transition-all flex items-center ${
      ...
      {detailModal && !termsModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4 animate-fadeIn">
          <div className="bg-gray-800/90 rounded-xl shadow-2xl p-6 sm:p-8 w-full max-w-md border border-gray-700/50">
            <h3 className="text-xl sm:text-2xl font-bold text-white mb-4 flex items-center">
              <FiInfo className="mr-2 text-green-400" /> Detalles del Producto
            </h3>
      ...
      {detailModal && termsModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4 animate-fadeIn">
          <div className="bg-gray-800/90 rounded-xl shadow-2xl p-6 sm:p-8 w-full max-w-md border border-gray-700/50">
            <h3 className="text-xl sm:text-2xl font-bold text-white mb-4 flex items-center">
              <FiFileText className="mr-2 text-green-400" /> Términos y Condiciones
            </h3>
            <div className="space-y-3 text-gray-300">
              <p>
            ...
            <div className="flex justify-end mt-6 space-x-3">
              ...
              {purchaseModal && (
                <button
                  ...
                  className="px-4 py-2 bg-green-400 text-white rounded-md hover:bg-green-500 transition-all"
                >
                  Volver a Compra
                </button>
              )}
      ...
      {generalTermsModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4 animate-fadeIn">
          <div className="bg-gray-800/90 rounded-xl shadow-2xl p-6 sm:p-8 w-full max-w-md border border-gray-700/50">
            <h3 className="text-xl sm:text-2xl font-bold text-white mb-4 flex items-center">
              <FiFileText className="mr-2 text-green-400" /> Términos Generales
            </h3>
      ...
      {notificationModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4 animate-fadeIn">
          <div className="bg-gray-800/90 rounded-xl shadow-2xl p-6 sm:p-8 w-full max-w-md border border-gray-700/50">
            <h3 className="text-xl sm:text-2xl font-bold text-white mb-4 flex items-center">
              <FiInfo className="mr-2 text-green-400" /> Notificación
            </h3>
