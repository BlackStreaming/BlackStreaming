    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-gray-200 flex flex-col">
      ...
      <div className="flex flex-1 relative">
        ...
        >
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-r from-gray-900/80 to-pink-900/50"></div>
            <div className="relative z-10 text-center px-4">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-200 max-w-2xl mx-auto drop-shadow-md">
                Conecta y destaca con nuestras cuentas premium de redes sociales
              </p>
            </div>
          </section>
          ...
          <section className="container mx-auto px-4">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 space-y-4 sm:space-y-0">
              ...
              <button
                ...
                className="text-sm sm:text-base text-pink-400 hover:text-pink-300 transition-all underline underline-offset-4"
              >
                Términos Generales
              </button>
            </div>
                ...
                <div className="flex items-start">
                  ...
                  <label htmlFor="termsCheck" className="text-sm text-gray-300">
                    ...
                    <button
                      ...
                      className="text-pink-400 hover:text-pink-300 transition-all underline underline-offset-4"
                    >
                      Términos
                    </button>{" "}
                    y{" "}
