...
const Capcut = () => {
  ...
  const renderProductStatus = (product) => {
    ...
    return (
      <div className="absolute top-0 left-0 w-24 h-8 bg-green-700 text-white flex items-center justify-center transform -rotate-45 -translate-x-6 translate-y-3 shadow-md rounded-br-lg">
        <span className="text-xs font-bold uppercase tracking-tight">
          Agotado
        </span>
      </div>
      ...
      <div className="flex flex-1 relative">
        ...
        >
          <section
            ...
            style={{
              backgroundImage:
                "url('https://images.unsplash.com/photo-1620114890640-79fcbbc1dd7e?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80')",
            }}
          >
            ...
            <div className="relative z-10 text-center px-4">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-200 max-w-2xl mx-auto drop-shadow-md">
                Crea videos profesionales con nuestras cuentas premium de Capcut
              </p>
            </div>
          </section>
            ...
            <div className="p-6 sm:p-8">
              ...
              <div className="flex justify-end space-x-3 mt-8">
                ...
                <button
                  ...
                  disabled={loading}
                  className="px-4 py-2 bg-green-500 text-white rounded-xl hover:bg-green-600 disabled:bg-gray-700/50 disabled:text-gray-400 flex items-center transition-all"
                >
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-md flex items-center justify-center z-50 p-4 sm:p-6">
          <div className="bg-gray-800/90 backdrop-blur-md rounded-2xl shadow-2xl w-full max-w-2xl max-h-[80vh] overflow-y-auto border border-gray-600/50 animate-fadeIn">
            <div className="p-6 sm:p-8">
              ...
              <button
                onClick={() => setGeneralTermsModal(false)}
                className="w-full mt-6 py-3 bg-green-500 text-white rounded-xl hover:bg-green-600 transition-all"
              >
                Cerrar
              </button>
            </div>
