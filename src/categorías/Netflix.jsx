...
const Netflix = () => {
    ...
    return (
      <div className="flex items-center space-x-1">
        {[...Array(fullStars)].map((_, i) => (
          <FiStar key={`full-${i}`} className="text-yellow-400" size={16} fill="currentColor" />
        ))}
        {hasHalfStar && (
          <FiStar
      ...
      async (snapshot) => {
        const productsData = snapshot.docs.map((doc) => {
          ...
          return {
            ...
            stock: Number(data.stock || data.available || 0), // Ensure stock is a number
      ...
      (snapshot) => {
        ...
        Object.keys(ratingsData).forEach((providerId) => {
          ...
          const average = ratings.length
            ...
            : 1; // Default to 1 if no ratings
          averageRatings[providerId] = Math.min(Math.max(average, 1), 5); // Cap between 1 and 5
        });
  ...
  const renderProductStatus = (product) => {
    // Prioritize status field for "A pedido"
    ...
    // Default to out of stock if stock is 0 or undefined
    return (
      ...
      <div className="flex flex-1 relative">
        ...
        >
          <div className="flex flex-col h-full">
            ...
            <nav className="flex-1 overflow-y-auto p-4 space-y-2">
              ...
              <Link
                to="/redessociales"
                className="flex items-center endangered justify-between px-4 py-3 rounded-xl text-gray-300 hover:bg-gray-800/50 transition-all"
              >
                <div className="flex items-center space-x-2">
        ...
        >
          <section
            ...
            style={{
              backgroundImage:
                "url('https://images.unsplash.com/photo-1522869635100-9f4c5e86aa37?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80')",
            }}
          >
            ...
            <div className="relative z-10 text-center px-4">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-200 max-w-2xl mx-auto drop-shadow-md">
                Disfruta de tus series y películas favoritas con nuestras cuentas premium de Netflix
              </p>
            </div>
          </section>
                  ...
                  >
                    ...
                    <div className="flex flex-col flex-grow p-4 pb-3">
                      <div className="flex items-center justify-between mb-1.5">
                        <span className="uppercase font-bold tracking-wide text-xs text-red-400 bg-red-900/20 px-2 py-0.5 rounded-md">
                          {product.accountType}
                        </span>
                        <span className="text-xs text-gray-400 flex items-center gap-1">
                          <FiClock className="text-red-400" size={13} />
                      ...
                      <div className="flex items-center gap-2 mb-2">
                        <span className="flex items-center text-xs text-gray-300 gap-1">
                          <FiUserCheck className="text-red-400" size={13} />
                          {product.provider}
                        </span>
                        <span className="flex items-center text-xs text-gray-400 gap-1">
                          <FiActivity className="text-red-400" size={13} />
                          {product.status}
                        </span>
                      </div>
                      ...
                      <div className="flex-1 flex flex-col justify-end">
                        ...
                        <div className="flex gap-2 mb-2">
                          ...
                          >
                            <FiInfo className="text-red-400" size={14} />
                            <span>Detalles</span>
                          </button>
                          <button
                            ...
                            style={{ backdropFilter: "blur(2px)" }}
                          >
                            <FiFileText className="text-red-400" size={14} />
                            <span>Términos</span>
                          </button>
                        </div>
                        <button
                          ...
                          className={`w-full py-2 px-3 rounded-xl font-semibold text-sm flex items-center justify-center gap-2 shadow-lg transition-all duration-200
                            ${
                              Number(product.stock) > 0 || product.status === "A pedido"
                                ? "bg-gradient-to-r from-red-500 via-red-600 to-pink-500 hover:from-red-600 hover:to-pink-600 text-white"
              ...
              <div className="flex items-center">
                ...
                <label htmlFor="termsCheck" className="ml-2 text-sm text-gray-300">
                  ...
                  <button
                    ...
                    className="text-red-400 hover:text-blue-300 underline underline-offset-2"
                  >
